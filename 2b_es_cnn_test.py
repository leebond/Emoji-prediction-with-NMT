...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 27 11:06:17 2019
...
if __name__ == '__main__':
    ...
    input_dictionary = pickle.load(open('./static/es_dictionary.pkl', 'rb'))
    ...
    #create a submission
    with open('./submission/es_cnn_test_submission', 'w+') as submission_file:
        for p in pred:
