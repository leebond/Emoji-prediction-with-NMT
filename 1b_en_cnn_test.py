...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 27 11:41:04 2019
...
if __name__ == '__main__':
    ...
    input_dictionary = pickle.load(open('./static/en_dictionary.pkl', 'rb'))
    ...
    cnn_model = load_model('./static/en_cnn_model.h5')
    p_v = cnn_model.predict(X_test_padded)
    pred = [np.argmax(p) for p in p_v]
       
    #create a submission
    with open('./submission/en_cnn_test_submission', 'w+') as submission_file:
        for p in pred:
